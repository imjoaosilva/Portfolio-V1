...
const components = {
	...
	ul: (props: React.ComponentProps<"ul">) => (
		<ul className="list-disc space-y-3 pl-6 text-[15px] leading-8 text-on-surface-variant" {...props} />
	),
	ol: (props: React.ComponentProps<"ol">) => (
		<ol className="list-decimal space-y-3 pl-6 text-[15px] leading-8 text-on-surface-variant" {...props} />
	),
